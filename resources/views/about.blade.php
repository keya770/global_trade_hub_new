        ...
        <div class="container mx-auto px-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div class="card fade-right text-center">
                    <div class="w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-6 bg-gradient-to-br from-[#305b73] to-[#4a7c95]">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-12">
                ...
                <div class="space-y-8">
                    <div class="flex items-start fade-left hover-card">
                        <div class="w-14 h-14 rounded-full flex items-center justify-center mr-6 mt-2 bg-gradient-to-br from-blue-400 to-blue-600 shadow-lg">
                    ...
                    <div class="flex items-start fade-left delay-1 hover-card">
                        <div class="w-14 h-14 rounded-full flex items-center justify-center mr-6 mt-2 bg-gradient-to-br from-green-400 to-green-600 shadow-lg">
                            <svg class="w-7 h-7 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 10V3L4 14h7v7l9-11h-7z"></path>
                            </svg>
                        </div>
                    ...
                    <div class="flex items-start fade-left delay-2 hover-card">
                        <div class="w-14 h-14 rounded-full flex items-center justify-center mr-6 mt-2 bg-gradient-to-br from-purple-400 to-purple-600 shadow-lg">
                            <svg class="w-7 h-7 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="space-y-8">
                    <div class="flex items-start fade-right hover-card">
                        <div class="w-14 h-14 rounded-full flex items-center justify-center mr-6 mt-2 bg-gradient-to-br from-red-400 to-red-600 shadow-lg">
                            <svg class="w-7 h-7 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="flex items-start fade-right delay-1 hover-card">
                        <div class="w-14 h-14 rounded-full flex items-center justify-center mr-6 mt-2 bg-gradient-to-br from-yellow-400 to-yellow-600 shadow-lg">
                            <svg class="w-7 h-7 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="flex items-start fade-right delay-2 hover-card">
                        <div class="w-14 h-14 rounded-full flex items-center justify-center mr-6 mt-2 bg-gradient-to-br from-pink-400 to-pink-600 shadow-lg">
                            <svg class="w-7 h-7 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
