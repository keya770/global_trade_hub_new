...
@section('title', 'Testimonials - Global Trade Hub')
        ...
        <div class="container mx-auto px-4">
            <div class="text-center mb-16">
                <h2 class="text-4xl font-extrabold mb-6 
                        ...
                        bg-clip-text text-transparent">Client Success Stories</h2>
                ...
                <div class="card fade-in">
                    <div class="flex items-center mb-4">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-500">CEO, Maritime Solutions Ltd</p>
                        </div>
                    </div>
                    <p class="text-gray-600 mb-4">
                        "Global Trade Hub has been instrumental in our fleet expansion. Their expertise in vessel acquisition 
                        and market analysis helped us make informed decisions that significantly improved our operations."
                    </p>
                ...
                <div class="card fade-in">
                    <div class="flex items-center mb-4">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-500">Operations Director, TankerCo</p>
                        </div>
                    </div>
                    <p class="text-gray-600 mb-4">
                        "The team at Global Trade Hub provided exceptional chartering services. Their market knowledge 
                        and negotiation skills helped us secure favorable terms for our tanker fleet."
                    </p>
                    <div class="flex text-yellow-400">
                        <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                            <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"></path>
                ...
                <div class="card fade-in">
                    <div class="flex items-center mb-4">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-500">Managing Director, Bulk Shipping Co</p>
                        </div>
                    </div>
                    <p class="text-gray-600 mb-4">
                        "Outstanding valuation services! Global Trade Hub's detailed analysis helped us understand 
                        the true market value of our vessels and make strategic decisions."
                    </p>
                    <div class="flex text-yellow-400">
                        <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                            <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"></path>
