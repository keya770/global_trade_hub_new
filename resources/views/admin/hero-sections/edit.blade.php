...
<div class="space-y-6">
    ...
    <div class="flex justify-between items-center">
        <div>
            ...
            <p class="text-gray-600">Update hero section for your homepage</p>
        </div>
    ...
    <div class="bg-white rounded-lg shadow-sm">
        <form action="{{ route('admin.hero-sections.update', $heroSection->id) }}" method="POST" enctype="multipart/form-data" class="p-6 space-y-6">
            @csrf
            @method('PUT')
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="accent_text" id="accent_text" value="{{ old('accent_text', $heroSection->accent_text) }}" 
                    ...
                    <div>
                        ...
                        <textarea name="hero_description" id="hero_description" rows="3" 
                                  ...
                                  placeholder="Main description text for the hero section">{{ old('hero_description', $heroSection->hero_description) }}</textarea>
                ...
                <div class="space-y-6">
                    ...
                    <div class="border-b border-gray-200 pb-4">
                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <input type="text" name="secondary_button_text" id="secondary_button_text" value="{{ old('secondary_button_text', $heroSection->secondary_button_text) }}" 
                            ...
                            <div>
                                ...
                                <input type="url" name="secondary_button_url" id="secondary_button_url" value="{{ old('secondary_button_url', $heroSection->secondary_button_url) }}" 
                    ...
                    <div>
                        ...
                        <div id="video-upload-area" class="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center hover:border-[#265478] transition-colors cursor-pointer">
                            ...
                            <div id="video-preview" class="{{ $heroSection->background_video ? '' : 'hidden' }}">
