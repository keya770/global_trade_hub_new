    ...
    <section class="section bg-white">
        <div class="container mx-auto px-4">
            <div class="text-center mb-16">
                ...
                <p class="section-subtitle">
                    Explore our latest vessel listings for sale and charter
                </p>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="card fade-in">
                    ...
                    <h3 class="text-xl font-bold mb-2">Bulk Carrier - 82,000 DWT</h3>
                    <p class="text-gray-600 mb-4">Built 2018, Excellent condition, Available for charter</p>
                    <div class="flex justify-between items-center">
                        <span class="text-primary-color font-semibold">$25,000/day</span>
                        <a href="{{ route('vessels') }}" class="btn-primary">Inquire</a>
                    </div>
                </div>
                ...
                <div class="card fade-in">
                    ...
                    <h3 class="text-xl font-bold mb-2">Tanker - 115,000 DWT</h3>
                    <p class="text-gray-600 mb-4">Built 2020, Modern specifications, For sale</p>
                    <div class="flex justify-between items-center">
                        <span class="text-primary-color font-semibold">$45M</span>
                        <a href="{{ route('vessels') }}" class="btn-primary">Inquire</a>
                    </div>
                </div>
                ...
                <div class="card fade-in">
                    ...
                    <h3 class="text-xl font-bold mb-2">Container Ship - 8,500 TEU</h3>
                    <p class="text-gray-600 mb-4">Built 2019, Eco-friendly design, Available for charter</p>
                    <div class="flex justify-between items-center">
                        <span class="text-primary-color font-semibold">$35,000/day</span>
                        <a href="{{ route('vessels') }}" class="btn-primary">Inquire</a>
                    </div>
                </div>
            </div>
            ...
            <div class="text-center mt-12">
                <a href="{{ route('vessels') }}" class="btn-secondary text-lg px-8 py-4">
                    View All Vessels
                </a>
            </div>
        </div>
