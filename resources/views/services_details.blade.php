...
@section('title', $service->name . ' - SMA Ship Brokers')
...
@section('content')
                ...
                <div class="fade-in">
                    ...
                    <div class="flex items-center text-white opacity-90">
                        ...
                        <div class="flex items-center">
                            ...
                            <span>{{ $service->created_at->format('F j, Y') }}</span>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container mx-auto px-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <article class="card bg-white">
                    ...
                    @endif
                    <div class="p-4">
                        <h3 class="text-lg font-bold mb-2 text-gray-800">{{ $subService->name }}</h3>
                        <p class="text-gray-600 text-sm mb-3">{{ $subService->description }}</p>
                        <a href="{{ route('services.sub.details', $subService) }}" class="text-primary-color text-sm font-semibold hover:underline">Learn More →</a>
                    </div>
                </article>
                @endforeach
            </div>
    ...
    <section class="section bg-white">
        <div class="container mx-auto px-4">
            <div class="text-center mb-16">
                <h2 class="text-3xl font-bold mb-4">Related Services</h2>
                <p class="text-gray-600">Other services you may be interested in</p>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <article class="card bg-white">
                    ...
                    @endif
                    <div class="p-4">
                        <h3 class="text-lg font-bold mb-2 text-gray-800">{{ $relatedService->name }}</h3>
                        <p class="text-gray-600 text-sm mb-3">{{ $relatedService->description }}</p>
                        <a href="{{ route('services.details', $relatedService) }}" class="text-primary-color text-sm font-semibold hover:underline">Learn More →</a>
                    </div>
                </article>
                @endforeach
            </div>
