            ...
            <div class="max-w-4xl mx-auto">
                ...
                <div class="content-image-container">
                    ...
                    <div class="image-overlay">
                        <div class="overlay-content">
                            <h3 class="overlay-title">{{ $service->name }}</h3>
                            <p class="overlay-desc">Professional Maritime Services</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="description-card">
                    ...
                    <div class="description-content">
                        <h3 class="description-title">Service Overview</h3>
            ...
            <div class="services-grid">
                ...
                <article class="service-card">
                    ...
                    <div class="card-content">
                        ...
                        <p class="card-description">{{ $subService->description }}</p>
                        <a href="{{ route('services.sub.details', $subService) }}" class="card-link">
    ...
    <section class="section bg-gradient-to-br from-gray-50 to-white">
        <div class="container mx-auto px-4">
            <div class="section-header">
                ...
                <p class="section-subtitle">Other services you may be interested in</p>
                <div class="section-divider"></div>
            </div>
            ...
            <div class="services-grid">
                ...
                <article class="service-card">
                    ...
                    <div class="card-content">
                        <h3 class="card-title">{{ $relatedService->name }}</h3>
                        <p class="card-description">{{ $relatedService->description }}</p>
                        <a href="{{ route('services.details', $relatedService) }}" class="card-link">
                            Learn More <i class="fas fa-arrow-right"></i>
                        </a>
                    </div>
                </article>
